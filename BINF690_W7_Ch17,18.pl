...
###3) takes polynomial data and uses guassian elimination to solve the equation.
...
if ($ans==1){
	...
	###UPDATE
		my @xvals = qw(1 2 3 4 5 6 7); ### 17.1
	...
	#Create arrays with x input
	###UPDATE
		my @xvals = qw(0 0.301 .477 .602 .699); ### 17.3
