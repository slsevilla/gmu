...
Random forests assesses a variables importance
by randomizing the positions a variables values
in the vector. The question then is, how much
does the models mean square error increase?
...
plot(yhat.bag, bostonTest,las=1)
abline(0,1)
title(main=paste("Boston Suburb Data",
  "Median Owner-occupied House Values $1000"),sep="\n")
