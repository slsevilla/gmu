...
plot_bar(st1, x="Timepoint", fill="Phylum") + facet_wrap(~SampleType)
```
...
abund_ranks <- abund_ranks -10#Number brings down scale of ranks
abund_ranks[abund_ranks < 12] <-1 #Anything below 1 gets a "tied" score
